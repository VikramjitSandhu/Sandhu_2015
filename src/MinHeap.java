...
This class simulates a min heap with the elements stored in an array.
The minimum element of the heap is stored at index 1 (2nd position)of 
...
public class MinHeap {
	...
	*/
	...
	/**
		this function restores the min heap property so that every
	...
	*/
	private void bubbleUp(int k){
		//while the new node is smaller than its parent, swap
	...
	*/
	public int removeMin(){
		...
		//return the minimum value stored at index 1 of the array
	...
	*/
	private void bubbleDown(int k){
		...
		while(2*k <= numberOfElements){
			...
			//swap it if it is greater than the child
